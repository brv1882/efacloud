...
class Tx_handler
{
    ...
    /**
     * The texts for the identification results to be returned to the client. These are never used yet and
     * rather for documentation reasons.
     */
    private static $server_resonse_texts = [300 => "Transaction completed.",
